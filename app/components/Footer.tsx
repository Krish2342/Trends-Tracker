        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <Link href="/" className="flex items-center space-x-2 group">
              ...
              <span className="font-bold text-xl text-white text-glow">TrendsTracker</span>
            </Link>
            ...
            <div className="flex items-center space-x-2 px-3 py-1 bg-gradient-to-r from-blue-600/20 to-purple-600/20 rounded-full border border-blue-400/30 w-fit">
              ...
              <span className="text-xs text-blue-300 font-medium">Analytics Platform</span>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="text-xs text-gray-500">
              <p>India-focused trend analytics</p>
            </div>
          </div>
        </div>

        <div className="border-t border-white/10 mt-8 pt-8 text-center text-sm text-gray-400">
        <p>&copy; 2025 TrendsTracker. India Trend Analytics Platform. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
