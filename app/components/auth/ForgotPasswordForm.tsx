...
import { Mail, ArrowLeft, AlertCircle, Loader2, CheckCircle, Shield } from "lucide-react"
    ...
    return (
      <Card className="w-full max-w-md mx-auto glass-card app-glow">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl font-bold text-white text-glow">Check Your Email</CardTitle>
  ...
  return (
    <Card className="w-full max-w-md mx-auto glass-card app-glow">
      <CardHeader className="text-center">
        ...
        <CardTitle className="text-2xl font-bold text-white text-glow">Reset Password</CardTitle>
        <CardDescription className="text-gray-400">
            ...
            <div className="flex items-start gap-2">
              ...
              <div className="text-xs text-blue-300">
                ...
                <ul className="space-y-1 text-blue-400">
                  ...
                  <li>• Only works for registered accounts</li>
