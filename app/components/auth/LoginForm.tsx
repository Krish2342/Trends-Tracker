  ...
  return (
    <Card className="w-full max-w-md mx-auto glass-card app-glow">
      <CardHeader className="text-center">
        ...
        <CardTitle className="text-2xl font-bold text-white text-glow">Welcome Back</CardTitle>
        <CardDescription className="text-gray-400">Sign in to access India Trends Tracker </CardDescription>
      </CardHeader>
      <CardContent>
