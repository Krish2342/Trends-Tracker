    ...
    <div className="min-h-screen bg-black">
      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-black via-gray-900 to-black">
        ...
        <div className="container mx-auto px-4 py-16 relative">
          <div className="text-center max-w-4xl mx-auto">
            <div className="mb-6">
              <Badge className="bg-gradient-to-r from-blue-600 to-purple-600 text-white border-0 mb-4 app-glow">
            ...
            <div className="flex max-w-2xl mx-auto mb-8 relative">
              ...
              <Button
                ...
                className="px-8 py-6 rounded-l-none bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-500 hover:to-purple-500 border-0 relative z-10 app-glow"
                size="lg"
              >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
              <Card className="glass-card app-glow-animate">
              ...
              <Card className="glass-card app-glow-animate">
                <CardContent className="p-6 text-center">
                  <BarChart3 className="w-8 h-8 mx-auto mb-4 text-purple-400" />
      ...
      <div className="container mx-auto px-4 py-12">
            ...
            <Card className="glass-card">
              <CardHeader>
                <CardTitle className="flex items-center gap-2 text-white">
                  ...
                  Featured Trend: "Cricket World Cup"
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mt-12">
          <Link href="/search">
            <Card className="glass-card hover:app-glow transition-all cursor-pointer group">
              <CardContent className="p-6 text-center">
